...
module.exports = async function handler(req, res) {
  ...
  function arrivalComplete(ac) {
    ...
    // Keep the ribbon through the landing roll. The joined map/story panel can
    // clear after ten seconds, leaving roughly ten more seconds of ribbon time.
    return Number(ac.stateAgeSeconds || 0) >= 20;
  }
