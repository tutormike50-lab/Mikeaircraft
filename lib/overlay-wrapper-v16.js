...
module.exports = async function handler(req, res) {
  ...
  res.send = function patchedSend(body) {
    ...
    html = html.replace("</style>", ".telemetry-strip.telemetry-red .metric-value{color:#ff4d4d!important}.telemetry-strip.telemetry-green .metric-value{color:#55e889!important}.mikeaircraft-logo{position:absolute;top:3.3vh;left:3vw;z-index:18;pointer-events:none;filter:drop-shadow(0 2px 5px rgba(0,0,0,.85));font-family:Arial,Helvetica,sans-serif}.ma-fuselage{position:relative;display:flex;align-items:center;height:30px;padding:0 23px 0 20px;background:linear-gradient(90deg,rgba(5,31,58,.94),rgba(7,70,110,.94));border:1px solid rgba(103,221,255,.85);border-radius:55% 80% 80% 45%;font-size:clamp(14px,1.05vw,20px);font-weight:900;font-style:italic;letter-spacing:.35px;line-height:1}.ma-fuselage:before{content:\"\";position:absolute;left:13px;top:-13px;width:7px;height:16px;background:#67ddff;clip-path:polygon(0 100%,100% 0,100% 100%)}.ma-fuselage:after{content:\"\";position:absolute;left:48%;top:25px;width:42px;height:17px;background:linear-gradient(135deg,#fff 0 45%,#67ddff 46% 100%);clip-path:polygon(0 0,100% 65%,13% 100%)}.ma-mike{color:#fff}.ma-aircraft{color:#67ddff}.ma-nose{position:absolute;right:-7px;width:15px;height:12px;background:#fff;border-radius:0 100% 100% 0;clip-path:polygon(0 8%,100% 50%,0 92%)}</style>");
