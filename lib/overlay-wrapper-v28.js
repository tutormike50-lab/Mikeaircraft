...
.ma-departure-panorama{
 ...
 border-radius:inherit;
 overflow:hidden;
 background-image:linear-gradient(90deg,rgba(2,18,31,.58) 0%,rgba(2,18,31,.22) 32%,rgba(2,18,31,.20) 68%,rgba(2,18,31,.58) 100%),linear-gradient(0deg,rgba(1,12,23,.30),rgba(1,12,23,.02)),url("/api/prague-departure-image");
 background-size:cover;
 background-position:center center;
 opacity:0;
 transform:scale(1.01);
...
showMain=function(current){
 ...
 if(currentKey!==window.__maCompletedMomentAircraftKey){
