...
.ma-ribbon-aircraft{
 ...
 left:49%;
 top:47%;
 width:clamp(92px,7.5vw,138px);
 color:rgba(151,228,255,.24);
 opacity:0;
...
.ma-ribbon-aircraft svg{display:none;width:100%;height:auto;fill:currentColor;filter:drop-shadow(0 2px 7px rgba(81,205,255,.16))}
.ma-ribbon-aircraft.arrival .arrival-icon{display:block}
.ma-ribbon-aircraft.departure .departure-icon{display:block}
...
(function addRibbonAircraftGraphic(){
 ...
 graphic.innerHTML='<svg class="arrival-icon" viewBox="0 0 640 512"><path d="M.3 166.9 0 68c0-10.3 9.5-17.9 19.5-15.7l35.6 7.9c10.6 2.3 19.2 9.9 23 20L96 128l127.3 37.6-41.5-145.2C178.9 10.2 186.6 0 197.2 0h40.1c11.6 0 22.2 6.2 27.9 16.3l109 193.8 107.2 31.7c15.9 4.7 30.8 12.5 43.7 22.8l34.4 27.6c24 19.2 18.1 57.3-10.7 68.2-41.2 15.6-86.2 18.1-128.8 7L121.7 289.8c-11.1-2.9-21.2-8.7-29.3-16.9L9.5 189.4c-5.9-6-9.3-14.1-9.2-22.5zM32 448h576c17.7 0 32 14.3 32 32s-14.3 32-32 32H32c-17.7 0-32-14.3-32-32s14.3-32 32-32zm96-80a32 32 0 1 1 64 0 32 32 0 1 1-64 0zm128-16a32 32 0 1 1 0 64 32 32 0 1 1 0-64z"/></svg><svg class="departure-icon" viewBox="0 0 640 512"><path d="M381 114.9 186.1 41.8c-16.7-6.2-35.2-5.3-51.1 2.7L89.1 67.4C78 73 77.2 88.5 87.6 95.2l146.9 94.5L136 240l-58.2-25.9c-8.7-3.9-18.8-3.7-27.3.6l-32.2 16.1c-9.3 4.7-11.8 16.8-5 24.7l73.1 85.3c6.1 7.1 15 11.2 24.3 11.2h137.7c5 0 9.9-1.2 14.3-3.4l272.9-136.4c46.5-23.3 82.5-63.3 100.8-112C645.9 75 627.2 48 600.2 48h-57.4c-20.2 0-40.2 4.8-58.2 14L381 114.9zM0 480c0 17.7 14.3 32 32 32h576c17.7 0 32-14.3 32-32s-14.3-32-32-32H32c-17.7 0-32 14.3-32 32z"/></svg>';
