...
.ma-ribbon-aircraft{
 ...
 left:48%;
 top:50%;
 width:clamp(150px,14vw,265px);
 color:rgba(139,222,255,.27);
 opacity:0;
...
.ma-ribbon-aircraft.arrival{transform:translate(-50%,-50%) rotate(4deg)}
.ma-ribbon-aircraft.departure{transform:translate(-50%,-50%) rotate(-5deg)}
.ma-ribbon-aircraft svg{display:block;width:100%;height:auto;overflow:visible;fill:currentColor;stroke:rgba(185,238,255,.34);stroke-width:1}
.ma-ribbon-aircraft .gear{fill:none;stroke:rgba(190,239,255,.42);stroke-width:2.2}
.ma-ribbon-aircraft.departure .gear{display:none}
...
(function addRibbonAircraftGraphic(){
 ...
 graphic.innerHTML='<svg viewBox="0 0 250 86"><path d="M9 47c18-3 43-6 72-8l35-2 43-22h13l-24 22 56 3c18 1 31 5 37 10-7 6-21 9-40 9h-64l-34 20H90l18-20H55c-23 0-39-3-46-8Z"/><path d="M40 40 25 24h12l30 14Z"/><path d="M179 38 205 25h10l-15 16Z"/><g class="gear"><path d="M93 58v9m54-9v9"/><circle cx="93" cy="70" r="3"/><circle cx="147" cy="70" r="3"/></g></svg>';
