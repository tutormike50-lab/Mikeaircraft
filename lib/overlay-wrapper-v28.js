...
.ma-css-radar-dot{position:absolute;width:7px;height:7px;margin:-3.5px 0 0 -3.5px;border-radius:50%;background:#68ffc2;box-shadow:0 0 7px rgba(104,255,194,.95);transition:left .95s linear,top .95s linear}
