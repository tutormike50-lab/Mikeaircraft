...
.ma-ribbon-aircraft{
 ...
 left:48%;
 top:50%;
 width:clamp(105px,9vw,175px);
 color:rgba(151,228,255,.32);
 opacity:0;
...
.ma-ribbon-aircraft.arrival,.ma-ribbon-aircraft.departure{transform:translate(-50%,-50%)}
.ma-ribbon-aircraft svg{display:none;width:100%;height:auto;overflow:visible;fill:currentColor;filter:drop-shadow(0 2px 7px rgba(81,205,255,.18))}
.ma-ribbon-aircraft.arrival .landing-icon{display:block}
.ma-ribbon-aircraft.departure .takeoff-icon{display:block}
...
(function addRibbonAircraftGraphic(){
 ...
 graphic.innerHTML='<svg class="landing-icon" viewBox="0 0 24 24"><path d="M2.5 19h19v2h-19v-2zm16.84-3.15c.8.21 1.62-.26 1.84-1.06.21-.8-.26-1.62-1.06-1.84l-5.31-1.42-2.76-9.02L10.12 2v8.28L5.15 8.95l-.93-2.32-1.45-.39v5.17l16.57 4.44z"/></svg><svg class="takeoff-icon" viewBox="0 0 24 24"><path d="M2.5 19h19v2h-19v-2zm19.57-9.36c-.21-.8-1.04-1.28-1.84-1.06L14.92 10l-6.9-6.43-1.93.51 4.14 7.17-4.97 1.33-1.97-1.54-1.45.39 2.59 4.49L21 11.49c.81-.23 1.28-1.05 1.07-1.85z"/></svg>';
