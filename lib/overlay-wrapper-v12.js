...
async function update(){
 ...
 try{
  ...
  // Render the editorial subject immediately. Auxiliary calls below are optional.
  ...
  if(!current?.available||closing){
   hideInfoPanel();
  }else if(srOK&&story?.ok){
   showStory(story)
  }else{
   document.getElementById("storyCard").classList.remove("visible","verified")
  }
